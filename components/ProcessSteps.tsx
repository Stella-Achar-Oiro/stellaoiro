        ...
        <div className="grid md:grid-cols-4 gap-8 relative">
          ...
          {steps.map((step, idx) => (
            <div key={step.number} className="relative">
              <div className="relative bg-white/95 backdrop-blur-sm rounded-xl p-6 shadow-sm hover:shadow-sm transition-all duration-300 border border-white/30">
                <div className="absolute -top-4 left-6 w-12 h-12 bg-gradient-to-br from-primary to-primary-light rounded-full flex items-center justify-center text-white font-bold shadow-lg">
                  {idx + 1}
                </div>
                <div className="mt-6">
