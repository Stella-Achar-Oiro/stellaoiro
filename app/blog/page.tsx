            ...
            {posts.map((post) => (
              <Link key={post.slug} href={`/blog/${post.slug}`}>
                <div className="relative group h-full">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-purple-500/5 rounded-xl blur-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
                  <div className="relative bg-white/95 backdrop-blur-sm rounded-xl shadow-sm hover:shadow-sm transition-all duration-300 border border-white/30 overflow-hidden h-full flex flex-col">
                    {post.image && (
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom max-w-4xl">
          <div className="relative">
            ...
            <div className="relative bg-white/95 backdrop-blur-sm rounded-xl p-8 md:p-12 shadow-sm border border-white/30 text-center">
