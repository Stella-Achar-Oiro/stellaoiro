...
I'm a father to Daniella Hera, who keeps me grounded and reminds me why building better healthcare systems matters. When I'm not coding or studying, I'm probably exploring how emerging technologies like AI and blockchain can solve healthcare challenges in African contexts.
...
Whether you're a healthcare startup needing cloud architecture, a tech team wanting to understand HIPAA, or a developer curious about transitioning into cloud engineering—I'd love to connect.

<div class="mt-12 p-8 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg text-center">
  <h3 class="text-3xl font-bold mb-4">Let's Work Together</h3>
  <p class="text-xl mb-6 opacity-90">I help healthcare companies and startups build secure, scalable cloud infrastructure</p>
  <div class="flex flex-col sm:flex-row gap-4 justify-center">
    <a href="/hire/" class="btn bg-white text-brand-blue hover:bg-gray-100 hover:no-underline">Hire Me</a>
    <a href="/blog/" class="btn border-2 border-white text-white hover:bg-white hover:text-brand-blue hover:no-underline">Read My Articles</a>
  </div>
</div>
...
*Father, Clinical Officer, Cloud Engineer, Teacher.* Not necessarily in that order.
