...
<form class="space-y-6" id="hire-form" netlify>
  <div>
  ...
  <div>
    ...
    <textarea id="description" name="description" required class="form-textarea" rows="5"></textarea>
  </div>

  <div>
    <label for="budget" class="form-label">Budget Range *</label>
    <select id="budget" name="budget" required class="form-input">
  ...
  <div>
    ...
    <select id="timeline" name="timeline" required class="form-input">
  ...
  <button type="submit" class="btn btn-primary w-full text-lg">Send Inquiry</button>
</form>
...
<div class="card">
  <div class="flex items-center mb-4">
    <div class="w-12 h-12 bg-brand-blue rounded-full flex items-center justify-center text-white font-bold mr-3">
      E
    </div>
    <div>
      <div class="font-bold">Evarest Technologies</div>
      <div class="text-sm text-text-secondary">Healthcare Startup</div>
    </div>
  </div>
  <p class="text-text-secondary italic">"Achar's unique background in both healthcare and cloud engineering made him the perfect fit for our projects. His understanding of HIPAA compliance and patient data security is unmatched."</p>
</div>
...
<div class="card">
  <div class="flex items-center mb-4">
    ...
    <div>
      <div class="font-bold">Kintaraa Platform</div>
      <div class="text-sm text-text-secondary">Social Impact Tech</div>
    </div>
  </div>
  <p class="text-text-secondary italic">"Working with Achar on our blockchain platform was fantastic. He designed a secure, scalable architecture that handles sensitive data for 847 survivors across Kisumu County."</p>
</div>
...
<div class="mt-16 text-center bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg p-12">
  ...
  <p class="text-xl mb-6 opacity-90">Let's discuss how I can help you build secure, scalable cloud infrastructure</p>
  <a href="#hire-form" class="btn bg-white text-brand-blue hover:bg-gray-100 hover:no-underline">Send Me Your Project Details</a>
</div>
